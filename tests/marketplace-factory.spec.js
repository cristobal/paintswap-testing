...
const baseURL = 'https://paintswap-staging-pr-791.herokuapp.com/marketplace/factory'
...
test('marketplace factory page evaluate urls under submenu container', marketplaceFactoryPageCreateEvaluateSubmenuUrls(baseURL, 'Info'))
